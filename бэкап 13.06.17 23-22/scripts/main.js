...
$(document).ready(function() {
    $(".testimonials-slider").owlCarousel({
        ...
        src = $(this).attr("src"), img = src.split("/"), console.log(img[1]), $(".modal-img").html("<div data-remodal-action='close' class='modal-close'></div><img class='img-responsive' src='img/complete-object-big/" + img[1] + "'></img>"), mod = $("[data-remodal-id=modal-img]").remodal(), mod.open()
